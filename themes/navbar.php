...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php?page=data_user">User</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php?page=biodata">Biodata</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php?page=prodi">Prodi</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php?page=matakuliah">Matakuliah</a>
      </li>
