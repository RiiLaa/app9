        ...
        <div class="col-sm-4">
            ...
            <div id="notifikasi">
                <div class="alert alert-danger">
                    <small>Gagal, Periksa Kembali Username dan Password</small>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="proses/crud.php?aksi=login" id="formlogin">
                        ...
                        <div class="form-group">
                            <button type="submit" name="proses_login" class="btn btn-success btn-block"> <span class="fa fa-sign-in"></span> Login  </button>
                        </div> <!-- form-group// -->
                    </form>
                    <div class="form-group">
