<?php
    ...
    if(!empty($_GET['aksi'] == 'tambah'))
    {
        ...
        echo '<script>alert("Tambah Data Berhasil");window.location="../index.php?page=data_user"</script>';
    }
    ...
    if(!empty($_GET['aksi'] == 'hapus'))
    {
        ...
        echo '<script>alert("Hapus Data Berhasil");window.location="../index.php?page=data_user"</script>';
    }
